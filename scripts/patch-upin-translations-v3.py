...
Uses language-specific Baca taglines as anchors to insert in the correct section.

Run: python3 /home/z/my-project/scripts/patch-upin-translations-v3.py
"""
...
coming_soon_translations = [
    ...
    ('Sulit', 'Akan Datang'),
    ('Sirri', 'Yana Zuwa Nan baba da da\u0257ewa'),
    ('\u00cdk\u1ecd\u0301k\u1ecd\u0301', 'N B\u1ecd\u0301 L\u00e0\u00ecp\u1eb9\u0301'),
    ('\u6a5f\u5bc6', '\u8fd1\u65e5\u516c\u958b'),
    ('\u0633\u0631\u064a', '\u0642\u0631\u064a\u0628\u0627\u064b'),
    ('\u673a\u5bc6', '\u5373\u5c06\u63a8\u51fa'),
]
...
# ── 4. Insert "Your Studio" project before each language's Baca entry ──
# Use the Baca tagline (unique per language) as the anchor

# Each entry: (baca_tagline, project_data)
projects_per_lang = [
    (  # en
        'Quran study tool with word-by-word analysis',
        {
    ...
    (  # ms
        'Alat kajian Quran dengan analisis perkataan-demi-perkataan',
        {
    ...
    (  # ha
        "Kayan aikin nazarin Alqur'ani tare da nazarin kalma-da-kalma",
        {
    ...
    (  # yo
        'Ohun \u00e8l\u00f2 \u1eb9\u0300k\u1ecd\u0301\u0301 Quran p\u1eb9\u0300l\u00fa \u00ectupal\u1eb9\u0300 \u1ecd\u0300r\u1ecd\u0300-l\u1ecd\u0301r\u1ecd\u0300',
        {
    ...
    (  # ar
        '\u0623\u062f\u0627\u0629 \u062f\u0631\u0627\u0633\u0629 \u0627\u0644\u0642\u0631\u0622\u0646 \u0645\u0639 \u062a\u062d\u0644\u064a\u0644 \u0643\u0644\u0645\u0629 \u0628\u0643\u0644\u0645\u0629',
        {
...
for baca_tagline, p in projects_per_lang:
    tech_array = ', '.join([f'"{t}"' for t in p['tech']])

    # The anchor: the Baca entry opening with its specific tagline
    anchor = f'''        {{
          name: "Baca",
          tagline: "{baca_tagline}",'''

    # The replacement: Your Studio entry + the Baca entry
    replacement = f'''        {{
          name: "{p['name']}",
          tagline: "{p['tagline']}",
          description:
    ...
    if anchor in content:
        ...
        print(f"  ✓ Inserted before Baca ({baca_tagline[:30]}...)")
    else:
        print(f"  ✗ Could not find anchor: {baca_tagline[:40]}...")
...
print(f'\nDone: {count} "comingSoon: true" entries added')
